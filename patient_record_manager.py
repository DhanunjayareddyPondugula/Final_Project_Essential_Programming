...
class PatientRecordManager:
    ...
    def write_patient_data_to_csv(self, patient_records): # added patient_records parameter
        with open(self.patient_file, 'w', newline='') as csvfile:
            ...
            writer.writeheader()
            for i, (patient_id, records) in enumerate(patient_records.items()): # changed to patient_records.items()
    ...
    def add_patient_record(self,patient_record):
        ...
        self.write_patient_data_to_csv(self.patient_records) # pass patient_records dictionary
